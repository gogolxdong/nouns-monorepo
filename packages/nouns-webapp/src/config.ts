...
export const CHAIN_ID: SupportedChains = parseInt(process.env.REACT_APP_CHAIN_ID ?? '31337');
...
export const multicallOnLocalhost = '0xeefba1e63905ef1d7acba5a8513c70307c1ce441';
